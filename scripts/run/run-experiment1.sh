...
then EXP_OPTIONS="Expcondition=experimental SetLogContext=true ProcessDataAfterAction=true CompoundTextActionLogicEnabled=true"
elif [ "$CONDITION" == "control-defaultactionselection" ]
then EXP_OPTIONS="ExpCondition=control-defaultactionselection SetLogContext=false ProcessDataAfterAction=false CompoundTextActionLogicEnabled=false"
elif [ "$CONDITION" == "control-customactionselection" ]
then EXP_OPTIONS="ExpCondition=control-customactionselection SetLogContext=false ProcessDataAfterAction=false CompoundTextActionLogicEnabled=true"

...
then EXP_OPTIONS="Expcondition=experimental SetLogContext=true SetCoverageContext=true ProcessDataAfterAction=true CompoundTextActionLogicEnabled=true DockerComposeDirectory=/data/studie/af/lightweight-codeanalysis/suts/ckan/run CarryOverCoverage=true StateModelEnabled=true"
elif [ "$CONDITION" == "plain" ]
then EXP_OPTIONS="ExpCondition=control-defaultactionselection SetLogContext=false SetCoverageContext=false ProcessDataAfterAction=false CompoundTextActionLogicEnabled=false DockerComposeDirectory=/data/studie/af/lightweight-codeanalysis/suts/ckan_plain/run CarryOverCoverage=false StateModelEnabled=false"
elif [ "$CONDITION" == "control-defaultactionselection" ]
then EXP_OPTIONS="ExpCondition=control-defaultactionselection SetLogContext=false SetCoverageContext=true ProcessDataAfterAction=false CompoundTextActionLogicEnabled=false DockerComposeDirectory=/data/studie/af/lightweight-codeanalysis/suts/ckan/run CarryOverCoverage=true StateModelEnabled=true"
elif [ "$CONDITION" == "control-customactionselection" ]
then EXP_OPTIONS="ExpCondition=control-customactionselection SetLogContext=false  SetCoverageContext=true ProcessDataAfterAction=false CompoundTextActionLogicEnabled=true DockerComposeDirectory=/data/studie/af/lightweight-codeanalysis/suts/ckan CarryOverCoverage=true StateModelEnabled=true"
